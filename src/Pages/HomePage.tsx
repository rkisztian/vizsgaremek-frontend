...
export default class HomePage extends Component {
    render(){
        ...
        const data = [
            {
                name: 'Karizom',
                discription : 'Ha a legjobb gyakorlatokat keresed, amelyek abban segítenek, hogy izmosabb, definiáltabb karjaid legyenek, akkor jó helyen jársz! Hiszen sokak leghőbb vágyai között szerepel a nagyobb kar, igaz? Akár egy teljes edzést a karizmaid építésének szentelnél, vagy éppen csak néhány kiegészítő gyakorlatot keresel, mi összegyűjtöttük, amire csak szükséged lehet a kiemelkedő eredményekhez! Bemutatjuk a karedzés gyakorlatainkból a legjobbakat.',
                alt: 'karizom',
                image: Karizom,
            },
            ...
            {
                name: 'Mellizom',
                discription: 'Talán az egyik legesztétikusabb része egy fizikumnak a jól kidolgozott <b>mellizom</b>. A mellizom edzés gyakorlatilag önálló fogalommá vált, és a hétfő hivatalosan is „nemzetközi mellnapnak” számít. Kezdő vagy haladó – sokan extra figyelmet fordítanak erre az izomcsoportra.Mik a legjobb gyakorlatok, hogy a mellizmainkat fejlesszük? Bemutatjuk a mell edzés gyakorlatainkból a legjobbakat.',
                alt: 'mellizom',
                image: Mellizom,
